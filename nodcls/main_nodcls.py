...
# Cal mean std
preprocesspath = 'D:\DeepLung-master - 没改\$LUNA16PROPOCESSPATH\subset9/'
pixvlu, npix = 0, 0
...
tefeatlst = []
import pandas as pd
dataframe = pd.read_csv('D:/DeepLung-master - 没改/nodcls/data/annotationdetclsconvfnl_v3.csv', \
...
for foldnum in range(0,1):
    for fname in os.listdir('D:\DeepLung-master - 没改\$DOWNLOADLUNA16PATH\LUNA16\subset0/'):
